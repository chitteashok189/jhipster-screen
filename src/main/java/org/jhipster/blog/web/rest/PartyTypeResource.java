...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.PartyType}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PartyTypeResource {
    ...
    public ResponseEntity<PartyType> createPartyType(@RequestBody PartyType partyType) throws URISyntaxException {
    ...
    public ResponseEntity<PartyType> partialUpdatePartyType(
        ...
        Optional<PartyType> result = partyTypeRepository
            ...
            .map(existingPartyType -> {
                if (partyType.getgUID() != null) {
                    existingPartyType.setgUID(partyType.getgUID());
                }
                if (partyType.getParentTypeID() != null) {
                    existingPartyType.setParentTypeID(partyType.getParentTypeID());
                }
                if (partyType.getHasTable() != null) {
                    existingPartyType.setHasTable(partyType.getHasTable());
                }
                if (partyType.getDescription() != null) {
                    existingPartyType.setDescription(partyType.getDescription());
                }
                if (partyType.getPartyTypeAttr() != null) {
                    existingPartyType.setPartyTypeAttr(partyType.getPartyTypeAttr());
                }
                if (partyType.getCreatedBy() != null) {
                    existingPartyType.setCreatedBy(partyType.getCreatedBy());
                }
                if (partyType.getCreatedOn() != null) {
                    existingPartyType.setCreatedOn(partyType.getCreatedOn());
                }
                if (partyType.getUpdatedBy() != null) {
                    existingPartyType.setUpdatedBy(partyType.getUpdatedBy());
                }
                if (partyType.getUpdatedOn() != null) {
                    existingPartyType.setUpdatedOn(partyType.getUpdatedOn());
                }
