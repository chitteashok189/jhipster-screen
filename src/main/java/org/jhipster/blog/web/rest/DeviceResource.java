...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.Device}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Device> partialUpdateDevice(
        ...
        Optional<Device> result = deviceRepository
            ...
            .map(existingDevice -> {
                ...
                if (device.getDeviceAsset() != null) {
                    existingDevice.setDeviceAsset(device.getDeviceAsset());
                }
                if (device.getDeviceType() != null) {
                    existingDevice.setDeviceType(device.getDeviceType());
                }
                if (device.getHardwareID() != null) {
                    existingDevice.setHardwareID(device.getHardwareID());
                }
                if (device.getReportingIntervalLocation() != null) {
                    existingDevice.setReportingIntervalLocation(device.getReportingIntervalLocation());
                }
                if (device.getParentDevice() != null) {
                    existingDevice.setParentDevice(device.getParentDevice());
                }
                ...
                if (device.getCreatedOn() != null) {
                    existingDevice.setCreatedOn(device.getCreatedOn());
                }
                if (device.getUpdatedBy() != null) {
                    existingDevice.setUpdatedBy(device.getUpdatedBy());
                }
                if (device.getUpdatedOn() != null) {
                    existingDevice.setUpdatedOn(device.getUpdatedOn());
                }
