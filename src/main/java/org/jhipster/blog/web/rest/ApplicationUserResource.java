...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.ApplicationUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<ApplicationUser> partialUpdateApplicationUser(
        ...
        Optional<ApplicationUser> result = applicationUserRepository
            ...
            .map(existingApplicationUser -> {
                if (applicationUser.getgUID() != null) {
                    existingApplicationUser.setgUID(applicationUser.getgUID());
                }
                if (applicationUser.getCurrentPassword() != null) {
                    existingApplicationUser.setCurrentPassword(applicationUser.getCurrentPassword());
                }
                if (applicationUser.getPasswordHint() != null) {
                    existingApplicationUser.setPasswordHint(applicationUser.getPasswordHint());
                }
                if (applicationUser.getIsSystemEnables() != null) {
                    existingApplicationUser.setIsSystemEnables(applicationUser.getIsSystemEnables());
                }
                if (applicationUser.getHasLoggedOut() != null) {
                    existingApplicationUser.setHasLoggedOut(applicationUser.getHasLoggedOut());
                }
                if (applicationUser.getRequirePasswordChange() != null) {
                    existingApplicationUser.setRequirePasswordChange(applicationUser.getRequirePasswordChange());
                }
                if (applicationUser.getLastCurrencyUom() != null) {
                    existingApplicationUser.setLastCurrencyUom(applicationUser.getLastCurrencyUom());
                }
                if (applicationUser.getLastLocale() != null) {
                    existingApplicationUser.setLastLocale(applicationUser.getLastLocale());
                }
                if (applicationUser.getLastTimeZone() != null) {
                    existingApplicationUser.setLastTimeZone(applicationUser.getLastTimeZone());
                }
                if (applicationUser.getDisabledDateTime() != null) {
                    existingApplicationUser.setDisabledDateTime(applicationUser.getDisabledDateTime());
                }
                if (applicationUser.getSuccessiveFailedLogins() != null) {
                    existingApplicationUser.setSuccessiveFailedLogins(applicationUser.getSuccessiveFailedLogins());
                }
                if (applicationUser.getApplicationUserSecurityGroup() != null) {
                    existingApplicationUser.setApplicationUserSecurityGroup(applicationUser.getApplicationUserSecurityGroup());
                }
                if (applicationUser.getCreatedBy() != null) {
                    existingApplicationUser.setCreatedBy(applicationUser.getCreatedBy());
                }
                if (applicationUser.getCreatedOn() != null) {
                    existingApplicationUser.setCreatedOn(applicationUser.getCreatedOn());
                }
                if (applicationUser.getUpdatedBy() != null) {
                    existingApplicationUser.setUpdatedBy(applicationUser.getUpdatedBy());
                }
                if (applicationUser.getUpdatedOn() != null) {
                    existingApplicationUser.setUpdatedOn(applicationUser.getUpdatedOn());
                }
