...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.Location}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Location> partialUpdateLocation(
        ...
        Optional<Location> result = locationRepository
            ...
            .map(existingLocation -> {
                if (location.getgUID() != null) {
                    existingLocation.setgUID(location.getgUID());
                }
                if (location.getBuildingNo() != null) {
                    existingLocation.setBuildingNo(location.getBuildingNo());
                }
                ...
                if (location.getOtherAddress() != null) {
                    existingLocation.setOtherAddress(location.getOtherAddress());
                }
                if (location.getCreatedBy() != null) {
                    existingLocation.setCreatedBy(location.getCreatedBy());
                }
                if (location.getCreatedOn() != null) {
                    existingLocation.setCreatedOn(location.getCreatedOn());
                }
                if (location.getUpdatedBy() != null) {
                    existingLocation.setUpdatedBy(location.getUpdatedBy());
                }
                if (location.getUpdatedOn() != null) {
                    existingLocation.setUpdatedOn(location.getUpdatedOn());
                }
