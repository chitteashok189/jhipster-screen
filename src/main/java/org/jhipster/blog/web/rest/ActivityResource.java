...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.Activity}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Activity> result = activityRepository
            ...
            .map(existingActivity -> {
                if (activity.getgUID() != null) {
                    existingActivity.setgUID(activity.getgUID());
                }
                ...
                if (activity.getUpdatedBy() != null) {
                    existingActivity.setUpdatedBy(activity.getUpdatedBy());
                }
