...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getOtherProductDetails() != null) {
                    existingProduct.setOtherProductDetails(product.getOtherProductDetails());
                }
                if (product.getPreviousEntry() != null) {
                    existingProduct.setPreviousEntry(product.getPreviousEntry());
                }
                ...
                if (product.getProductEntryName() != null) {
                    existingProduct.setProductEntryName(product.getProductEntryName());
                }
