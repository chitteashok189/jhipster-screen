...
/**
 * REST controller for managing {@link org.jhipster.blog.domain.Zone}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ZoneResource {
    ...
    public ResponseEntity<Zone> partialUpdateZone(@PathVariable(value = "id", required = false) final Long id, @RequestBody Zone zone)
        ...
        Optional<Zone> result = zoneRepository
            .findById(zone.getId())
            .map(existingZone -> {
                if (zone.getgUID() != null) {
                    existingZone.setgUID(zone.getgUID());
                }
                ...
                if (zone.getCreatedBy() != null) {
                    existingZone.setCreatedBy(zone.getCreatedBy());
                }
                if (zone.getCreatedOn() != null) {
                    existingZone.setCreatedOn(zone.getCreatedOn());
                }
                if (zone.getUpdatedBy() != null) {
                    existingZone.setUpdatedBy(zone.getUpdatedBy());
                }
                if (zone.getUpdatedOn() != null) {
                    existingZone.setUpdatedOn(zone.getUpdatedOn());
                }
