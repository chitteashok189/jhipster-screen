...
import { ClimateUpdateComponent } from './climate-update.component';

describe('Climate Management Update Component', () => {
  let comp: ClimateUpdateComponent;
  let fixture: ComponentFixture<ClimateUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ClimateUpdateComponent],
      providers: [
        FormBuilder,
        {
      ...
      .overrideTemplate(ClimateUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ClimateUpdateComponent);
    activatedRoute = TestBed.inject(ActivatedRoute);
    climateService = TestBed.inject(ClimateService);
  ...
  describe('ngOnInit', () => {
    it('Should call Device query and add missing value', () => {
      const climate: IClimate = { id: 456 };
      const deviceID: IDevice = { id: 35015 };
      climate.deviceID = deviceID;

      const deviceCollection: IDevice[] = [{ id: 17061 }];
      ...
      activatedRoute.data = of({ climate });
      comp.ngOnInit();
    ...
    it('Should call PlantFactory query and add missing value', () => {
      const climate: IClimate = { id: 456 };
      const plantFactoryID: IPlantFactory = { id: 75801 };
      climate.plantFactoryID = plantFactoryID;

      const plantFactoryCollection: IPlantFactory[] = [{ id: 29815 }];
    ...
    it('Should update editForm', () => {
      const climate: IClimate = { id: 456 };
      const deviceID: IDevice = { id: 86 };
      climate.deviceID = deviceID;
      const plantFactoryID: IPlantFactory = { id: 66992 };
      climate.plantFactoryID = plantFactoryID;

      activatedRoute.data = of({ climate });
      comp.ngOnInit();

      expect(comp.editForm.value).toEqual(expect.objectContaining(climate));
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      // GIVEN
      const saveSubject = new Subject<HttpResponse<Climate>>();
      const climate = { id: 123 };
      jest.spyOn(climateService, 'update').mockReturnValue(saveSubject);
      ...
      saveSubject.next(new HttpResponse({ body: climate }));
      saveSubject.complete();

      // THEN
      expect(comp.previousState).toHaveBeenCalled();
      expect(climateService.update).toHaveBeenCalledWith(climate);
    ...
    it('Should call create service on save for new entity', () => {
      ...
      jest.spyOn(climateService, 'create').mockReturnValue(saveSubject);
      jest.spyOn(comp, 'previousState');
      activatedRoute.data = of({ climate });
      comp.ngOnInit();
      ...
      // THEN
      expect(climateService.create).toHaveBeenCalledWith(climate);
      expect(comp.isSaving).toEqual(false);
      expect(comp.previousState).toHaveBeenCalled();
    });
