...
describe('Crop routing resolve service', () => {
  ...
  let resultCrop: ICrop | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new ICrop if id is not provided', () => {
      // GIVEN
      ...
      expect(resultCrop).toEqual(new Crop());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Crop })));
      mockActivatedRouteSnapshot.params = { id: 123 };
