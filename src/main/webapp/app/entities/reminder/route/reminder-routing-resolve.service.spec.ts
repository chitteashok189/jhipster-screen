...
describe('Reminder routing resolve service', () => {
  ...
  let resultReminder: IReminder | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IReminder if id is not provided', () => {
      // GIVEN
      ...
      expect(resultReminder).toEqual(new Reminder());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Reminder })));
      mockActivatedRouteSnapshot.params = { id: 123 };
