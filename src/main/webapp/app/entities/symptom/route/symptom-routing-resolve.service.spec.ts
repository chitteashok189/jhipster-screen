...
describe('Symptom routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return ISymptom returned by find', () => {
      // GIVEN
      ...
      expect(resultSymptom).toEqual({ id: 123 });
    });
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Symptom })));
      mockActivatedRouteSnapshot.params = { id: 123 };
